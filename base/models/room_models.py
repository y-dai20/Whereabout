...
class RoomTabSequence(models.Model):
    room = models.OneToOneField(Room, primary_key=True, on_delete=models.CASCADE)
    tab1 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content1")
    tab2 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content2")
    tab3 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content3")
    tab4 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content4")
    tab5 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content5")
    tab6 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content6")
    tab7 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content7")
    tab8 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content8")
    tab9 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content9")
    tab10 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab_content10")
    is_deleted = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
