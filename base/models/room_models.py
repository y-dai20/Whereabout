...
class Room(models.Model):
    ...
    tag1 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag1')
    tag2 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag2')
    tag3 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag3')
    tag4 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag4')
    tag5 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag5')
    tag6 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag6')
    tag7 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag7')
    tag8 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag8')
    tag9 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag9')
    tag10 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='room_tag10')
...
class RoomTabSequence(models.Model):
    room = models.OneToOneField(Room, primary_key=True, on_delete=models.CASCADE)
    tab1 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab1")
    tab2 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab2")
    tab3 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab3")
    tab4 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab4")
    tab5 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab5")
    tab6 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab6")
    tab7 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab7")
    tab8 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab8")
    tab9 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab9")
    tab10 = models.ForeignKey(RoomTab, null=True, on_delete=models.CASCADE, related_name="tab10")
    is_deleted = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
