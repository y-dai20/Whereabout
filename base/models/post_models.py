...
class Post(models.Model):
    ...
    tag1 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='post_tag1')
    tag2 = models.ForeignKey(Tag, on_delete=models.CASCADE, null=True, related_name='post_tag2')
